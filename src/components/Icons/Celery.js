...
const SvgCelery = props => (
  <svg width={137.136} height={137.136} id="celery_svg__svg3392" {...props}>
    <path
      ...
      id="celery_svg__path4707-0"
      fill="#ff9a09"
    />
    <style id="style4689" />
    <g id="celery_svg__g4984" transform="translate(-1.836 -13)">
      <path
        id="celery_svg__rect3542-0"
